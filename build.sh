...
function create_archive() {
  ...
  rnzoo_prefix="rnzoo-$VERSION-darwin-amd64"
  ...
  tar $taropt "$rnzoo_prefix".tar.gz "./$rnzoo_prefix"

  mv "$rnzoo_prefix".tar.gz $current/$dest_dir/
  shasum -a 256 "$current/$dest_dir/$rnzoo_prefix.tar.gz"
